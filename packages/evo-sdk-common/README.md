...
See the [Getting Started](docs/quickstart.md) guide for how to use this library. There is also more detailed information about authentication options in [the OAuth examples](docs/oauth.md), and a selection of interactive Jupyter notebooks in the [examples folder](docs/examples).
